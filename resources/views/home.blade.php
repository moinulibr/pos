...
@push('js')   
    <script src="{{ asset('admin/links/assets/jquery-sparkline/jquery.sparkline.min.js') }}"></script>  ---
    <script src="{{ asset('admin/links/assets/chat/moment-2.2.1.js') }}"></script>  -----


    <!-- sweet alerts -->
    <script src="{{ asset('admin/links/assets/sweet-alert/sweet-alert.min.js') }}"></script>
    <script src="{{ asset('admin/links/assets/sweet-alert/sweet-alert.init.js') }}"></script>

    <!-- flot Chart -->
    <script src="{{ asset('admin/links/assets/flot-chart/jquery.flot.js') }}"></script>
    <script src="{{ asset('admin/links/assets/flot-chart/jquery.flot.time.js') }}"></script>
    <script src="{{ asset('admin/links/assets/flot-chart/jquery.flot.tooltip.min.js') }}"></script>
    <script src="{{ asset('admin/links/assets/flot-chart/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('admin/links/assets/flot-chart/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('admin/links/assets/flot-chart/jquery.flot.selection.js') }}"></script>
    <script src="{{ asset('admin/links/assets/flot-chart/jquery.flot.stack.js') }}"></script>
    <script src="{{ asset('admin/links/assets/flot-chart/jquery.flot.crosshair.js') }}"></script>

    <!-- Counter-up -->
    <script src="{{ asset('admin/links/assets/counterup/waypoints.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('admin/links/assets/counterup/jquery.counterup.min.js') }}" type="text/javascript"></script>

    <!-- Dashboard -->
    <script src="{{ asset('admin/links/js/jquery.dashboard.js') }}"></script>

    <!-- Chat -->
    <script src="{{ asset('admin/links/js/jquery.chat.js') }}"></script>

    <!-- Todo -->
    <script src="{{ asset('admin/links/js/jquery.todo.js') }}"></script>
