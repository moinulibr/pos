            ...
            <div class="content-page">
                    ...
                    <div class="content">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="pull-left page-title">Add Warehouse Section</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Add Warehouse Section</h3></div>
                                    <div class="panel-body">            
                                        <div class=" form">                                                                         <!--id="signupForm" novalidate="novalidate"--->          
                                            <form method="POST" action="{{ route('warehouse_section.store') }}"  class="cmxform form-horizontal tasi-form" novalidate="novalidate"  enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group ">
                                                    <label for="name" class="control-label col-lg-3">Section Name *</label>
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('name') }}"  class=" form-control" id="name" name="name" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('description') }}" class=" form-control" id="description" name="description" required type="text">
