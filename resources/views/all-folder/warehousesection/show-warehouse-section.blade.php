            ...
            <div class="content-page">
                    ...
                    <div class="content">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="pull-left page-title">All Warehouse Section</h4>
                                    <ol class="breadcrumb pull-right">
                                        <li><a href="#">Moltran</a></li>
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <table id="datatable" class="table table-striped table-bordered">
                                                        ...
                                                        <tbody style="font-size:12px;color:black;">
                                                            @foreach ($warehouse_section as $item)
                                                                <tr>
                                                                    <td>{{ $item->name }}</td>
                                                                    <td>{{ $item->warehouse->name }}</td>
                                                                    <td>{{ $item->description }}</td>                                            
                                                                    <td>
                                                                       <a href="{{ route('total_product_by_warehouse_wareSection',[$item->id,$item->warehouse->id]) }}"> Product 
                                                                        <span class="badge bg-blue" style="padding-left:4%px; padding-right:4%px;"> {{ total_product_by_warehouse_wareSection($item->id,$item->warehouse->id) }} </span> View  </a>
                                                                    </td>
                                                                    <td>
                                                                        {{ $item->status == 1?'Jobin':'Jobout' }}
                                                                    </td>
                                                                    <td>
                                                                        <a href="{{ route('warehouse_section.edit',$item->id) }}" class="btn btn-xs btn-primary"> <i class="fa fa-edit"></i></a>
