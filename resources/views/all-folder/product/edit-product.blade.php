                                        ...
                                        <div class=" form">                                                                         <!--id="signupForm" novalidate="novalidate"--->          
                                            <form method="POST" action="{{ route('product.update',$product->id) }}"  class="cmxform form-horizontal tasi-form" novalidate="novalidate"  enctype="multipart/form-data">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('product_name')?? $product->product_name }}"  class=" form-control" id="product_name" name="product_name" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('product_code')?? $product->product_code }}"  class="form-control " name="product_code" type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select  class="warehouse_section form-control" id="warehouse_section" name="warehouse_section">
                                                          @foreach($warehouse_section as $ws)
                                                          <option value="{{ $ws->id }}" {{ $product->warehouse_section == $ws->id ?'selected':'' }} >{{ $ws->name }}</option>
                                                          @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('buying_price')?? $product->buying_price }}" class=" form-control" id="buying_price" name="buying_price" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('selling_price')?? $product->selling_price }}"  class=" form-control" id="selling_price" name="selling_price" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('expire_date')?? $product->expire_date	 }}"  class=" form-control" id="expire_date" name="expire_date" required type="date">
