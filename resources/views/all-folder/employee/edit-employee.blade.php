                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">            
                                        <div class=" form">                                                                         <!--id="signupForm" novalidate="novalidate"--->          
                                            <form method="POST" action="{{ route('employee.update',$employee->id) }}"  class="cmxform form-horizontal tasi-form" novalidate="novalidate"  enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group ">
                                                    <label for="firstname" class="control-label col-lg-3">Name *</label>
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('name') ?? $employee->name }}"  class=" form-control" id="firstname" name="name" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('mail')??$employee->email }}"  class="form-control " name="mail" type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('phone')?? $employee->phone }}"  class=" form-control" id="phone" name="phone" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('nid_no')?? $employee->nid_no }}"  class=" form-control" id="nid_no" name="nid_no" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('address')?? $employee->address }}" class=" form-control" id="address" name="address" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('experience') ?? $employee->experience }}"  class=" form-control" id="experience" name="experience" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('salary')?? $employee->salary }}"  class=" form-control" id="salary" name="salary" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('vacation')?? $employee->vacation }}" class=" form-control" id="vacation" name="vacation" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('city') ?? $employee->city }}"  class=" form-control" id="city" name="city" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select  class=" form-control" id="user_roll" name="user_roll">
                                                            <option {{ $employee->user_roll == 2 ?'selected':'' }} value="2">Select two</option>
                                                            <option {{ $employee->user_roll == 1 ?'selected':'' }} value="1">Select one</option>
                                                            <option {{ $employee->user_roll == 3 ?'selected':'' }} value="3">Select three</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="firstname" style="margin-top:1%;" class="control-label col-lg-3">Uploading Photo *</label>
                                                    <div class="col-lg-8">
                                                        <img id="image" src="#" />
