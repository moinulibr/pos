                    ...
                    <div class="content">
                        <div class="container">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                            <a  class="btn btn-sm btn-info pull-left" data-toggle="modal" data-target="#con-close-modal"> Add Customer</a>
                                            <a  class="btn btn-sm btn-info pull-right" href="{{ route('show-my-cart') }}"> Your Cart</a>
                                    </div>
                                    <div class="col-sm-1"></div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-5" style="overflow:hidden;">
                                        <div class="row" style="margin-bottom:5px;">
                                            <div class="col-sm-12">
                                                ...
                                                <a  class="btn btn-sm btn-info pull-left" href="{{ route('show-my-cart') }}"> Your Cart</a>
                                            </div>
                                        </div>
