            ...
            <div class="content-page">
                    ...
                    <div class="content">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="pull-left page-title">All Supplier Type</h4>
                                    <ol class="breadcrumb pull-right">
                                        <li><a href="#">Moltran</a></li>
                                                        ...
                                                        <tbody style="font-size:12px;color:black;">
                                                            @foreach ($supplier_type as $item)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                       <a href="{{ route('total_product_by_category',$item->id) }}"> Product 
                                                                        <span class="badge bg-blue" style="padding-left:4%px; padding-right:4%px;"> {{ 0 }} </span> View  </a>
                                                                    </td>
                                                                    <td>
                                                                        {{ $item->status == 1?'Jobin':'Jobout' }}
                                                                    </td>
                                                                    <td>
                                                                        <a href="{{ route('suppliertype.edit',$item->id) }}" class="btn btn-xs btn-primary"> <i class="fa fa-edit"></i></a>
