                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">            
                                        <div class=" form">                                                                         <!--id="signupForm" novalidate="novalidate"--->          
                                            <form method="POST" action="{{ route('category.update',$category->id) }}"  class="cmxform form-horizontal tasi-form" novalidate="novalidate"  enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group ">
                                                    <label for="name" class="control-label col-lg-3">Category Name *</label>
                                                    <div class="col-lg-8"> 
                                                        <input value="{{ old('name') ?? $category->name }}"  class=" form-control" id="name" name="name" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8"> 
                                                        <input value="{{ old('description') ?? $category->description }}" class=" form-control" id="description" name="description" required type="text">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-offset-3 col-lg-10">
                                                        ...
                                                        <a  class="btn btn-default waves-effect" href="{{ route('category.show') }}">Cancel</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div> <!-- .form -->
