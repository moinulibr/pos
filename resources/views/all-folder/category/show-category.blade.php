                                                    ...
                                                    @foreach ($category as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="badge bg-blue" style="padding-left:4%px; padding-right:4%px;"> {{ count_product($item->id) }} </span> View  </a>
                                                            </td>
                                                            <td>
                                                                {{ $item->status == 1?'Jobin':'Jobout' }}
                                                            </td>
                                                            <td>
                                                                <a href="{{ route('category.edit',$item->id) }}" class="btn btn-xs btn-primary"> <i class="fa fa-edit"></i></a>
