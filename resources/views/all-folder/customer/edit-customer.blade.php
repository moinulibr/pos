            ...
            <div class="content-page">
                    ...
                    <div class="content">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="pull-left page-title">Update Customer</h4>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">            
                                        <div class=" form">                                                                         <!--id="signupForm" novalidate="novalidate"--->          
                                            <form method="POST" action="{{ route('customer.update',$customer->id) }}"  class="cmxform form-horizontal tasi-form" novalidate="novalidate"  enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group ">
                                                    <label for="firstname" class="control-label col-lg-3">Name *</label>
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('name')?? $customer->name }}"  class=" form-control" id="firstname" name="name" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('mail')?? $customer->email }}"  class="form-control " name="mail" type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('phone')?? $customer->phone }}"  class=" form-control" id="phone" name="phone" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('address')?? $customer->address }}" class=" form-control" id="address" name="address" required type="text">
                                                ...
                                                <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input value="{{ old('shop_name')?? $customer->shop_name }}"  class=" form-control" id="shop_name" name="shop_name" type="text" required>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('account_name')?? $customer->account_name }}"  class=" form-control" id="account_name" name="account_name" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('account_number')?? $customer->account_number }}"  class=" form-control" id="account_number" name="account_number" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('bank_name')?? $customer->bank_name }}" class=" form-control" id="bank_name" name="bank_name" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('brance_name')?? $customer->brance_name }}" class=" form-control" id="brance_name" name="brance_name" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input value="{{ old('city')?? $customer->city }}"  class=" form-control" id="city" name="city" required type="text">
                                                ...
                                                <div class="form-group ">
                                                    <label for="firstname" class="control-label col-lg-3">Customer Ref. <small></small></label>
                                                    <div class="col-lg-8">
                                                        <select  class=" form-control" id="customer_ref" name="customer_ref">
                                                            <option {{ $customer->customer_ref == 1 ? 'selected':'' }} value="1">Select One</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                            ...
                                                            <img src="{{ asset("admin/other/customer/profile/picture/customer-profile-{$customer->id}-1.{$customer->photo}") }}" alt="imgae" style="width:60px; height:60px;"/>
                                                            @else 
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-offset-3 col-lg-10">
                                                        ...
                                                        <a  class="btn btn-default waves-effect" href="{{ route('customer.show') }}">Cancel</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div> <!-- .form -->
